<template>
	<div class="match-summary-card rounded-sm flex justify-between items-center shadow-lg bg-white rounded-xl px-4 my-1 border-none border-black-400 hover:bg-gray-100 transition-colors w-full min-w-[550px]">
		<!-- Left player -->
